...
As the outcome and predictors are all quantitative data, it would be not proper to fit the model in Logistic Regression or exponential function. Thus linear regression may be still the best choice for use to build the model. 
